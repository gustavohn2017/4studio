"""
Django settings for voicetel project.
...
WSGI_APPLICATION = 'voicetel.wsgi.application'
...
ADMIN_EMAIL = 'admin@voicetel.com.br'  # Update for production
